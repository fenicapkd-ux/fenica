...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-screen w-full flex-col overflow-hidden text-black outline-none select-none overflow-x-hidden",
        className
      )}
              ...
              >
                ...
                <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 z-10 h-14 w-14">
                  <button
                    ...
                    aria-label="Next"
                  >
                    <PlayCircle className="h-14 w-14 rounded-full" />
                  </button>
                </div>
                {/* Lighting layers */}
